...
### Класс BaseProduct(ABC):
#### Абстрактный базовый класс для всех продуктов

### Класс MixinPrintInfo
#### Выводит на печать в консоль информацию о том, от какого класса и с какими параметрами был создан объект.
...
### Подкласс Smartphone(Product)
#### Наследует родительские свойства класса Product
#### Собственные свойства:
- производительность (efficiency),
- модель (model),
- объем встроенной памяти (memory).

### Подкласс LawnGrass(Product)
#### Наследует родительские свойства класса Product
#### Собственные свойства:
